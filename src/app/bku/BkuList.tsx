          ...
          <tbody className="bg-white/5">
            ...
            {!sortDesc && (
              <tr className="bg-indigo-500/5 border-b border-indigo-500/10 italic">
                ...
                <td className="px-4 py-3 text-indigo-300 font-bold uppercase tracking-wider">Saldo Bulan Lalu</td>
                <td className="px-4 py-3 text-right text-emerald-400 font-bold">{formatCurrency(openingBalance)}</td>
